      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 gap-4">
          ...
          <Link to="/" className="flex items-center gap-2 hover:opacity-90 transition-opacity flex-shrink-0">
            ...
            <span className="text-xl font-black bg-gradient-to-r from-pink-600 to-purple-600 bg-clip-text text-transparent whitespace-nowrap hidden sm:block">
              Cosmetics Shop
            </span>
          </Link>
          ...
          <nav className="hidden lg:flex items-center gap-6 flex-shrink-0">
            <Link
              to="/"
              className="text-lg font-semibold text-gray-800 hover:text-pink-600 transition-colors whitespace-nowrap"
            >
              Trang chủ
            </Link>
            <Link
          ...
          <div className="flex items-center gap-3 flex-shrink-0">
            ...
            <form onSubmit={handleSearch} className="flex-1 max-w-xs">
              <div className="relative">
                <input
                  ...
                  className="w-full pl-9 pr-3 py-1.5 border-2 border-pink-200 rounded-lg focus:outline-none focus:border-pink-500 transition-all text-sm"
                />
                <svg
            ...
            <Link
              to="/cart"
              className="relative p-2 text-gray-800 hover:text-pink-600 transition-all group flex-shrink-0"
            >
              <svg
            ...
            {isAuthenticated ? (
              <div className="hidden lg:flex items-center gap-2">
                ...
                <button
                  onClick={logout}
                  className="flex items-center gap-1.5 px-3 py-1.5 bg-red-500 text-white rounded-lg hover:bg-red-600 font-semibold text-base shadow-md hover:shadow-lg transition-all whitespace-nowrap"
                >
              ...
              <>
                ...
                <Link
                  to="/login"
                  className="lg:hidden px-3 py-1.5 bg-gradient-to-r from-pink-500 to-purple-600 text-white rounded-lg font-semibold text-base transition-all whitespace-nowrap flex-shrink-0"
                >
                  Đăng nhập
                </Link>
                ...
                <div className="hidden lg:flex items-center gap-2">
                  <Link
                    to="/login"
                    className="text-lg font-semibold text-gray-800 hover:text-pink-600 transition-all whitespace-nowrap"
                  >
                    Đăng nhập
                  </Link>
                  <Link
                    to="/register"
                    className="px-4 py-1.5 bg-gradient-to-r from-pink-500 to-purple-600 text-white rounded-lg hover:shadow-lg font-semibold text-base transition-all whitespace-nowrap"
                  >
                    Đăng ký
                  </Link>
                </div>
            ...
            <button
              ...
              className="lg:hidden p-2 text-gray-800 hover:text-pink-600 transition-colors flex-shrink-0"
              aria-label="Menu"
            >
